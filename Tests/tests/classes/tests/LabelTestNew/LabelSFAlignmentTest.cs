...
namespace tests
{
    ...
    public class LabelSFAlignmentTest : AtlasDemoNew
    {
        ...
        private void updateAlignment()
        {
            ...
            var labelFormat = new CCLabelFormat(CCLabelFormatFlags.SpriteFont) { Alignment = horizontalAlign, LineAlignment = verticalAlign };

            alignmentLabel = new CCLabel(getCurrentAlignment(), "MarkerFelt", 32,
        ...
        public override string Title
        {
            get 
            {
                return "Testing New Label - SpriteFont";
            }
        }
