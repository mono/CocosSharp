...
namespace tests.Extensions
{
    public class S9SpriteTestDemo : CCControlScene
    {
        ...
        {
            base.OnEnter();
            CCApplication.SharedApplication.SpriteFrameCache.AddSpriteFrames("Images/blocks9ss.plist");
    ...
    public class S9_TexturePacker : S9SpriteTestDemo
    {
        public override void OnEnter()
        {
            base.OnEnter();
            CCSize winSize = CCApplication.SharedApplication.MainWindowDirector.WindowSizeInPoints;
            CCApplication.SharedApplication.SpriteFrameCache.AddSpriteFrames("Images/ui.plist");
