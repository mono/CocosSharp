...
namespace tests.Extensions
{
    public class CCControlSliderTest : CCControlScene
	{
		...
		public void valueChanged(object sender, CCControlEvent controlEvent)
		{
			...
			if (pSlider.Tag == 1)
				m_pDisplayValueLabel.Text = (String.Format("Upper slider value = {0:2}", pSlider.Value));
			if (pSlider.Tag == 2)
				m_pDisplayValueLabel.Text = (String.Format("Lower slider value = {0:2}", pSlider.Value));
		}
