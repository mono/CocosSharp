...
namespace CocosSharp
{
    ...
    /// 
    /// This will change all characters to uppercase.
    /// Code changes are in KeyboardInputView
    /// </summary>
    internal class UppercaseIMEKeyboardImpl : ICCIMEDelegate
    {
        private bool isVisible;
        private string contentText;

        private static UppercaseIMEKeyboardImpl instance;
        ...
        public static UppercaseIMEKeyboardImpl SharedInstance
        {
            get
            {
                if (instance == null) 
                {
                    instance = new UppercaseIMEKeyboardImpl ();
    ...
    class KeyboardInputView : UIScrollView {
        ...
        private class TextFieldDelegate : UITextFieldDelegate
        {
            ...
            // Override the ShouldChangeCharacters to convert all incoming characters to uppercase
            public override bool ShouldChangeCharacters (UITextField textField, NSRange range, string replacementString)
            {
                var nsstring = (NSString)textField.Text;
                if (nsstring != null)
                    textField.Text = nsstring.Replace (range, (NSString)replacementString.ToUpper ());
                return false;
            }
        }
    }
