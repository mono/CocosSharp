...
namespace tests
{
    public class EffectAdvanceTextLayer : CCLayer
    {
        ...
        public override void OnEnter()
        {
            ...
            grossini.RunAction(CCRepeatForever.Create((CCActionInterval)(CCSequence.FromActions(sc, sc_back))));
            ...
            tamara.RunAction(CCRepeatForever.Create((CCActionInterval)(CCSequence.FromActions(sc2, sc2_back))));
