...
namespace tests
{
    public class LabelFNTAdditionalKerningTest : AtlasDemoNew
    {
        ...
        public LabelFNTAdditionalKerningTest()
        {
        ...
        public override void OnEnter()
        {
            ...
            label = new CCLabel("Test\nadditional\nkerning", "fonts/arial-unicode-26.fnt");
        ...
        private void UpdateAdditionalKerning ()
        {
            var left = arrowsBar.PositionX - arrowsWidthCenter;
            var newKerning = (arrows.PositionX - left) / arrowsWidth * 100;

            label.AdditionalKerning = newKerning;
        }
        ...
        private void snapArrowsToEdge()
        {
            ...
            {
                SetPercentage(label.AdditionalKerning);
            }
            else
            {
