...
namespace tests
{
    public class RenderTextureTestDepthStencil : RenderTextureTestDemo
    {
        public RenderTextureTestDepthStencil()
        {
			...
			CCRenderTexture rend = new CCRenderTexture((int)s.Width, (int)s.Height, CCSurfaceFormat.Color, CCDepthFormat.Depth24Stencil8, RenderTargetUsage.DiscardContents);
