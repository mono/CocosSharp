...
namespace tests
{
    public class SpriteBatchNodeReorderIssue767 : SpriteTestDemo
    {
        public SpriteBatchNodeReorderIssue767()
        {
            ...
            // child right
            l2b = CCSprite.Create(scope + "sister2.gif");
