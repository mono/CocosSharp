    ...
    public class SpriteBatchNodeOffsetAnchorFlip : SpriteTestDemo
    {
        public SpriteBatchNodeOffsetAnchorFlip()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                CCFiniteTimeAction seq = CCSequence.Create((CCFiniteTimeAction)delay, (CCFiniteTimeAction)flip, (CCFiniteTimeAction)delay.CopyWithZone(null), (CCFiniteTimeAction)flip_back);
