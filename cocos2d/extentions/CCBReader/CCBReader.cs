...
namespace cocos2d
{
    ...
    {
        SEL_MenuHandler OnResolveCCBCCMenuItemSelector(CCObject target, string pSelectorName);
        SEL_CCControlHandler OnResolveCCBCCControlSelector(CCObject target, string pSelectorName);
    }
    ...
    public class CCBReader : CCObject
    {
        ...
        public bool InitWithData(byte[] bytes, CCObject owner)
        {
        ...
        public CCNode ReadNodeGraphFromFile(string fileName, CCObject owner)
        {
            return ReadNodeGraphFromFile(fileName, owner, CCDirector.SharedDirector.WinSize);
        }

        public CCNode ReadNodeGraphFromFile(string fileName, CCObject owner, CCSize parentSize)
        {
            CCBAnimationManager dummy = null;
            return ReadNodeGraphFromFile(fileName, owner, parentSize, ref dummy);
        }

        public CCNode ReadNodeGraphFromFile(string fileName, CCObject owner, ref CCBAnimationManager animationManager)
        {
        ...
        public CCNode ReadNodeGraphFromData(byte[] bytes, CCObject owner, CCSize parentSize, ref CCBAnimationManager animationManager)
        {
        ...
        public CCNode ReadNodeGraphFromData(byte[] bytes, CCObject owner, CCSize parentSize)
        {
            CCBAnimationManager dummy = null;
        ...
        public CCScene CreateSceneWithNodeGraphFromFile(string fileName, CCObject owner)
        {
            return CreateSceneWithNodeGraphFromFile(fileName, owner, CCDirector.SharedDirector.WinSize);
        }

        public CCScene CreateSceneWithNodeGraphFromFile(string fileName, CCObject owner, CCSize parentSize)
        {
            CCBAnimationManager dummy = null;
        ...
        /*
        public CCScene createSceneWithNodeGraphFromFile(string pCCBFileName, CCObject owner, ref CCBAnimationManager animationManager)
        {
