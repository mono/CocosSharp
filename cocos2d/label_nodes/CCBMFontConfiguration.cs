...
namespace cocos2d
{
    ...
    public class CCBMFontConfiguration
    {
        ...
        /// <returns></returns>
        public static Cocos2D.CCBMFontConfiguration Create(string fntFile)
        {
            try
            {
                return new Cocos2D.CCBMFontConfiguration(Cocos2D.CCApplication.SharedApplication.Content.Load<cocos2d.CCBMFontConfiguration>(fntFile));
            }
            catch (ContentLoadException)
            {
                ...
                {
                    return new Cocos2D.CCBMFontConfiguration(pRet);
                }
            }
            return null;
        }
