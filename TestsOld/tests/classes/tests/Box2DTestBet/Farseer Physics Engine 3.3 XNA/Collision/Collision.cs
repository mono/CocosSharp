...
namespace FarseerPhysics.Collision
{
    ...
    public struct AABB
    {
        ...
        */
        ...
        {
            Perimeter = 2.0f * ((UpperBound.X - LowerBound.X) + (UpperBound.Y - LowerBound.Y));
        }
        ...
        public AABB Q4
        {
            ...
            {
                var center = Center;
                return new AABB(new Vector2(center.X, LowerBound.Y), new Vector2(UpperBound.X, center.Y));
            }
        }
    ...
    public static class Collision
    {
                                            ...
                                            PolygonShape poly2, ref Transform xf2)
        {
            ...
            var vertices2 = poly2.Vertices.Elements;

            var xf2_R_Col1_X = xf2.R.Col1.X;
            var xf2_R_Col1_Y = xf2.R.Col1.Y;
            var xf2_R_Col2_X = xf2.R.Col2.X;
            var xf2_R_Col2_Y = xf2.R.Col2.Y;

            var xf1_R_Col1_X = xf1.R.Col1.X;
            var xf1_R_Col1_Y = xf1.R.Col1.Y;
            var xf1_R_Col2_X = xf1.R.Col2.X;
            var xf1_R_Col2_Y = xf1.R.Col2.Y;
            ...
            float normalWorldx = xf1_R_Col1_X * p1n.X + xf1_R_Col2_X * p1n.Y;
            float normalWorldy = xf1_R_Col1_Y * p1n.X + xf1_R_Col2_Y * p1n.Y;

            Vector2 normal = new Vector2(normalWorldx * xf2_R_Col1_X + normalWorldy * xf2_R_Col1_Y,
                                         normalWorldx * xf2_R_Col2_X + normalWorldy * xf2_R_Col2_Y);
            ...
            {
                float dot;
                Vector2.Dot(ref vertices2[i], ref normal, out dot);
            ...
            Vector2 p2vi = vertices2[index];

            return ((xf2.Position.X + xf2_R_Col1_X * p2vi.X + xf2_R_Col2_X * p2vi.Y) -
                    (xf1.Position.X + xf1_R_Col1_X * p1ve.X + xf1_R_Col2_X * p1ve.Y)) * normalWorldx +
                   ((xf2.Position.Y + xf2_R_Col1_Y * p2vi.X + xf2_R_Col2_Y * p2vi.Y) -
                    (xf1.Position.Y + xf1_R_Col1_Y * p1ve.X + xf1_R_Col2_Y * p1ve.Y)) * normalWorldy;
        }
