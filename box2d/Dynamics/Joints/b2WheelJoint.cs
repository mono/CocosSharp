...
b2Vec2 b2WheelJoint::GetAnchorA(
{
    return m_bodyA.GetWorldPoint(m_localAnchorA);
}

b2Vec2 b2WheelJoint::GetAnchorB(
{
    return m_bodyB.GetWorldPoint(m_localAnchorB);
}

b2Vec2 b2WheelJoint::GetReactionForce(float inv_dt
{
    return inv_dt * (m_impulse * m_ay + m_springImpulse * m_ax);
}

float b2WheelJoint::GetReactionTorque(float inv_dt
{
    return inv_dt * m_motorImpulse;
}

float b2WheelJoint::GetJointTranslation(
{
    b2Body bA = m_bodyA;
    b2Body bB = m_bodyB;
...
float b2WheelJoint::GetJointSpeed(
{
...
bool b2WheelJoint::IsMotorEnabled(
{
...
float b2WheelJoint::GetMotorTorque(float inv_dt
{
    return inv_dt * m_motorImpulse;
}
