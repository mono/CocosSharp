                ...
                float r)
{
    ...
    lengthB = dB.Length();
    ratio = r;
    Debug.Assert(ratio > b2_epsilon);
}

b2PulleyJoint::b2PulleyJoint(b2PulleyJointDef* def)
: b2Joint(def)
{
...
void b2PulleyJoint::InitVelocityConstraints(b2SolverData& data)
{
...
void b2PulleyJoint::SolveVelocityConstraints(b2SolverData& data)
{
    b2Vec2 vA = data.velocities[m_indexA].v;
    float wA = data.velocities[m_indexA].w;
    b2Vec2 vB = data.velocities[m_indexB].v;
    ...
    float Cdot = -b2Dot(m_uA, vpA) - m_ratio * b2Math.b2Dot(m_uB, vpB);
...
bool b2PulleyJoint::SolvePositionConstraints(b2SolverData& data)
{
    b2Vec2 cA = data.positions[m_indexA].c;
    float aA = data.positions[m_indexA].a;
    b2Vec2 cB = data.positions[m_indexB].c;
...
b2Vec2 b2PulleyJoint::GetAnchorA(
{
    return m_bodyA.GetWorldPoint(m_localAnchorA);
}

b2Vec2 b2PulleyJoint::GetAnchorB(
{
    return m_bodyB.GetWorldPoint(m_localAnchorB);
}

b2Vec2 b2PulleyJoint::GetReactionForce(float inv_dt
{
    b2Vec2 P = m_impulse * m_uB;
    return inv_dt * P;
}

float b2PulleyJoint::GetReactionTorque(float inv_dt
{
    B2_NOT_USED(inv_dt);
    return 0.0f;
}

b2Vec2 b2PulleyJoint::GetGroundAnchorA(
{
    return m_groundAnchorA;
}

b2Vec2 b2PulleyJoint::GetGroundAnchorB(
{
    return m_groundAnchorB;
}

float b2PulleyJoint::GetLengthA(
{
...
float b2PulleyJoint::GetLengthB(
{
