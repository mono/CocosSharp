...
b2Vec2 b2RopeJoint::GetAnchorA(
{
    return m_bodyA.GetWorldPoint(m_localAnchorA);
}

b2Vec2 b2RopeJoint::GetAnchorB(
{
    return m_bodyB.GetWorldPoint(m_localAnchorB);
}

b2Vec2 b2RopeJoint::GetReactionForce(float inv_dt
{
    b2Vec2 F = (inv_dt * m_impulse) * m_u;
    return F;
}

float b2RopeJoint::GetReactionTorque(float inv_dt
{
    B2_NOT_USED(inv_dt);
    return 0.0f;
}

float b2RopeJoint::GetMaxLength(
{
    return m_maxLength;
}

b2LimitState b2RopeJoint::GetLimitState(
{
    return m_state;
}
