...
b2Vec2 b2RevoluteJoint::GetReactionForce(float inv_dt
{
    b2Vec2 P(m_impulse.x, m_impulse.y);
    return inv_dt * P;
}

float b2RevoluteJoint::GetReactionTorque(float inv_dt
{
...
float b2RevoluteJoint::GetMotorTorque(float inv_dt
{
...
float b2RevoluteJoint::GetLowerLimit(
{
    return m_lowerAngle;
}

float b2RevoluteJoint::GetUpperLimit(
{
    return m_upperAngle;
}
