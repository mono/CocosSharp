...
b2PrismaticJoint(b2PrismaticJointDef def) : base(def)
{
...
float GetJointSpeed(
{
    ...
    b2Vec2 rA = b2Math.b2Mul(bA.m_xf.q, m_localAnchorA - bA.Sweep.localCenter);
    b2Vec2 rB = b2Math.b2Mul(bB.m_xf.q, m_localAnchorB - bB.Sweep.localCenter);
